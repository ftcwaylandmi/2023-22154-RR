...
public class DriveConstants {
     ...
     * width; it zwill be tune empirically later although a rough estimate is important). Users are
    ...
    public static double TRACK_WIDTH = 10.84; // in
     ...
     * empirically tuned.
     */
    public static double kV = 0.00034; //1.0 / rpmToVelocity(MAX_RPM);
    public static double kA = 0.08295;
    public static double kStatic = 0.03374;
